...
# Unit tests for TreezorClient::InlineResponse2001
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2001' do
  before do
    # run before each test
    @instance = TreezorClient::InlineResponse2001.new
  end
  ...
  describe 'test an instance of InlineResponse2001' do
    it 'should create an instance of InlineResponse2001' do
      expect(@instance).to be_instance_of(TreezorClient::InlineResponse2001)
    end
  end
