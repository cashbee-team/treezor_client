...
# Unit tests for TreezorClient::Virtualiban
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Virtualiban' do
  before do
    # run before each test
    @instance = TreezorClient::Virtualiban.new
  end
  ...
  describe 'test an instance of Virtualiban' do
    it 'should create an instance of Virtualiban' do
      expect(@instance).to be_instance_of(TreezorClient::Virtualiban)
    end
  end
  ...
  describe 'test attribute "max_usage"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
