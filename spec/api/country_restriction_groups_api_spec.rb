...
# Unit tests for TreezorClient::CountryRestrictionGroupsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CountryRestrictionGroupsApi' do
  before do
    # run before each test
    @instance = TreezorClient::CountryRestrictionGroupsApi.new
  end
  ...
  describe 'test an instance of CountryRestrictionGroupsApi' do
    it 'should create an instance of CountryRestrictionGroupsApi' do
      expect(@instance).to be_instance_of(TreezorClient::CountryRestrictionGroupsApi)
    end
  end

  # unit tests for delete_country_restriction_groups
  ...
  describe 'delete_country_restriction_groups test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_country_restriction_groups
  ...
  # @return [InlineResponse20016]
  describe 'get_country_restriction_groups test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_country_restriction_groups_id
  # get a country group
  ...
  # @option opts [Array<String>] :fields List of the object&#39;s properties you want to pick up.
  # @return [InlineResponse20016]
  describe 'get_country_restriction_groups_id test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_country_restriction_group
  ...
  # @return [InlineResponse20016]
  describe 'post_country_restriction_group test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_country_restriction_groups
  ...
  # @return [InlineResponse20016]
  describe 'put_country_restriction_groups test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
