...
module TreezorClient
  class Bankaccount
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bankaccountStatus')
        self.bankaccount_status = attributes[:'bankaccountStatus']
      end
      ...
      if attributes.has_key?(:'bankaccountOwnerName')
        self.bankaccount_owner_name = attributes[:'bankaccountOwnerName']
      end

      if attributes.has_key?(:'bankaccountOwnerAddress')
        self.bankaccount_owner_address = attributes[:'bankaccountOwnerAddress']
      end
      ...
      if attributes.has_key?(:'bankaccountBIC')
        self.bankaccount_bic = attributes[:'bankaccountBIC']
      end

      if attributes.has_key?(:'bankaccountType')
        self.bankaccount_type = attributes[:'bankaccountType']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bankaccount_status == o.bankaccount_status &&
          user_id == o.user_id &&
          name == o.name &&
          bankaccount_owner_name == o.bankaccount_owner_name &&
          bankaccount_owner_address == o.bankaccount_owner_address &&
          bankaccount_iban == o.bankaccount_iban &&
          bankaccount_bic == o.bankaccount_bic &&
          bankaccount_type == o.bankaccount_type &&
    ...
    def hash
      [bankaccount_id, bankaccount_status, user_id, name, bankaccount_owner_name, bankaccount_owner_address, bankaccount_iban, bankaccount_bic, bankaccount_type, created_date, modified_date, total_rows].hash
    end
