...
module TreezorClient
  class Virtualiban
    ...
    def initialize(attributes = { })
      ...
      if attributes.has_key?(:'maxUsage')
        self.max_usage = attributes[:'maxUsage']
      end
    ...
    def hash
      [virtual_iban_id, wallet_id, type_id, tag, reference, valid_from, valid_to, max_usage, max_amount, iban, created_date].hash
    end
