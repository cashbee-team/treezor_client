...
module TreezorClient
  class IssuerInitiatedDigitizationData
    # Tav request Id
    attr_accessor :id
    ...
    attr_accessor :credential, :created_date, :modified_date
    ...
    def initialize(attributes = { })
      ...
      if attributes.has_key?(:'additionnalData')
        if (value = attributes[:'additionnalData']).is_a?(Array)
          self.additionnal_data = value
        end
      end
    ...
    def hash
      [id, card_id, status_id, credential, additionnal_data, token_requestor, created_date, modified_date].hash
    end
