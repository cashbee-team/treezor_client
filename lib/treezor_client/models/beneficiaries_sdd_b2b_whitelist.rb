...
module TreezorClient
  class BeneficiariesSddB2bWhitelist
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isRecurrent')
        self.is_recurrent = attributes[:'isRecurrent']
      end
    ...
    def hash
      [unique_mandate_reference, is_recurrent, wallet_id].hash
    end
